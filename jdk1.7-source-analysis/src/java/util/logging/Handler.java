...
public abstract class Handler {
    ...
    private LogManager manager = LogManager.getLogManager();  //日志管理器
    private Filter filter;
    private Formatter formatter;          
    private Level logLevel = Level.ALL;    //日志级别
    private ErrorManager errorManager = new ErrorManager(); //错误管理器
    ...
    public void setFormatter(Formatter newFormatter) throws SecurityException {
        checkPermission();
        // Check for a null pointer: 检查空指针 
